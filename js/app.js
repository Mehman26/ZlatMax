(() => {
    ...
    (() => {
            ...
            if (document.querySelector(".main-block__slider")) new core(".main-block__slider", {
                ...
                on: {
                    ...
                    slideChange: function(swiper) {
                        const currentSlide = document.querySelector(".fraction-controll__curent");
        ...
        if (menuBloks.length) menuBloks.forEach((menuBloks => {
            const menuBloksItems = menuBloks.querySelectorAll(".sub-menu-catalog__category").length;
            menuBloks.classList.add(`sub-menu-catalog__block_${menuBloksItems}`);
        }));
